# -*- coding: utf-8 -*-
"""
Created on Tue Feb 18 10:11:50 2020

@author: Mathieu Reine
"""

"""Application de la fonction de masse sur tout un tableau csv, sous la méthode affine"""
...
def masses_file(f):#Fonction qui prend un fichier f et qui effectue la transformation de masses sur chacune des évaluations
    ...
    df['masses'] = df['note'].apply(lambda x:masses_x(x,param))#On applique à la colonne des notes la fonction de transformation de masses choisie
    ...
    df.to_csv(f[:-4]+'_masses.csv', sep = ';',index = False)
